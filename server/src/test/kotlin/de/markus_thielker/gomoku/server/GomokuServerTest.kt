...
class GomokuServerTest {
    ...
    fun sendValidHistoryPushMessage() {
        ...
        testClient.send(helloServerJson)
        Thread.sleep(DELAY_TIME_MILLISECONDS.toLong())
        assert(1 == testClient.messages_received.size)
        val answer : String = testClient.messages_received.poll()
        val welcomeClient = gson.fromJson(answer, WelcomeClient::class.java)
        ...
        Thread.sleep(DELAY_TIME_MILLISECONDS.toLong())
        assert(1 == testClient.messages_received.size)
        val historySaved : HistorySaved = gson.fromJson(testClient.messages_received.poll(), HistorySaved::class.java)
    ...
    fun sendInvalidHistoryPushMessage() {
        ...
        Thread.sleep(DELAY_TIME_MILLISECONDS.toLong())
        assert(1 == testClient.messages_received.size)
        val historyNotSaved : HistoryNotSaved = gson.fromJson(testClient.messages_received.poll(), HistoryNotSaved::class.java)
    ...
    fun sendTwoHistoryPushMessages() {
        ...
        Thread.sleep(DELAY_TIME_MILLISECONDS.toLong())
        assert(2 == testClient.messages_received.size)
        val history1Saved : HistorySaved = gson.fromJson(testClient.messages_received.poll(), HistorySaved::class.java)
        assert(history1Saved.messageType === MessageType.HistorySaved)
        val history2Saved : HistorySaved = gson.fromJson(testClient.messages_received.poll(), HistorySaved::class.java)
    ...
    fun sendTwoHistoryPushMessagesAndGetAll() {
        ...
        Thread.sleep(DELAY_TIME_MILLISECONDS.toLong())
        assert(1 == testClient.messages_received.size)
        val historyAll : HistoryAll = gson.fromJson(testClient.messages_received.poll(), HistoryAll::class.java)
    ...
    fun sendGoodbyeServerMessage() {
        ...
        Thread.sleep(DELAY_TIME_MILLISECONDS.toLong())
        assert(1 == testClient.messages_received.size)
        val goodbyeClient : GoodbyeClient = gson.fromJson(testClient.messages_received.poll(), GoodbyeClient::class.java)
        assert(goodbyeClient.goodbyeMessage == "Servus!")
        assert(testClient.connection_closed)
        testClient.close()
        server.stop()
    }
